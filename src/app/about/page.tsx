      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-ink-muted leading-relaxed">
            文章プロンプトの生成はすべてブラウザ内で完結し、入力した内容は外部サーバーに送信されません。
            画像・動画プロンプトの生成は、入力内容を本サービスのサーバー経由で Google Gemini API へ送信します
            （本サービスは入力・出力を保存しません。Google 側の取り扱いは Google の規約に従います）。
            機密性の高い内容は、ブラウザ内で完結する文章プロンプト生成でご利用ください。
          </p>
        </section>
